...
export abstract class BasePage {
   ...
   * Useful for advanced test scenarios requiring direct page access
   */
  get page(): Page {
    return this._page;
  }
  ...
  async waitForToast(message: string): Promise<Locator> {
    const toast = this._page.locator('[data-sonner-toast]', { hasText: message });
  ...
  async getFocusedElement(): Promise<Locator> {
    return this._page.locator(':focus');
  }
}
